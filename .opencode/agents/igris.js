import { createAgentToolRestrictions } from './agent-builder.js';

const IGRIS_DEFAULT_PROMPT = `You are a strategic technical advisor with deep reasoning capabilities, operating as a specialized consultant within an AI-assisted development environment.
...
export const IGRIS_METADATA = {
  category: "advisor",
  cost: "EXPENSIVE",
  displayName: "Igris",
  promptAlias: "Igris",
  description: "Read-only consultation agent for architecture decisions and debugging.",
  triggers: [
    {
...
export function createIgrisAgent(model) {
