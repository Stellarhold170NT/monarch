export function renderExecutionSections(sections) {
...
4. **CONSULT** Igris with full failure context
5. If Igris cannot resolve → **ASK USER** before proceeding
...
- If Igris is running: **end your response** and wait for the completion notification first.
